BCCE-official-api-docs
============================================
Official Documentation for the [BCCE][] APIs and Streams([简体中文版文档][])
...
<!-- /TOC -->
# Introduction
Welcome to [BCCE][] API document for developers.
...
Before signing any request, you must generate an API key via BCCE’s official website 【User Center】- 【API】. After generating the key, there are three things you must bear in 
mind:
* API Key
...
```
Message = '1590000000.281GET/api/v1/orders?limit=100{"code": "ct_usdt", "side": "buy", "type": "limit", "size": "1", "price": "0.1", "funds": ""}'
```
...
## Request Process 
  
The root URL for REST access：`https://www.bcce.com`
...
### 2. Order Placement
    ...
    There are two categrories of orders that can be placed on BCCE -- limit order and market order.
...
[简体中文版文档]: https://github.com/BCCE-XCH/BCCE-official-api-docs/blob/master/README.md
